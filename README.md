...
Для удобства проверки задания, в корне проекта можно выполнить команду:

```bash
docker-compose up -d --build
```

После этого можно сразу выполнять запросы к реализованным эндпоинтам, представленные ниже.
Миграции базы данных и заполнение таблиц тестовыми данными (фикстурами) произойдут автоматически при старте контейнера.
